...
class _WeatherApi implements WeatherApi {
  ...
  @override
  Future<List<Timezone>> search(String q) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'q': q};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Timezone>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<CurrentTemperature> forecast(
    ...
    late CurrentTemperature _value;
    try {
      _value = CurrentTemperature.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
